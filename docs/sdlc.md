...
Current allocated iteration version: `v0.19.5`

Documentation evidence commit: `2b3afce` (baseline commit to be set on merge; latest `origin/main` baseline: `v0.19.3`)
